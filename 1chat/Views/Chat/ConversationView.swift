...
struct MessageView: View {
    ...
    var thinkingLabel: some View {
        HStack {
            ...
            Text("\(isThinking ? "thinking...".localized() : "thought for".localized()) \(time)")
                .italic()
        }
...
//
//                        let output = await llm.generate(thread: thread, systemPrompt: "")
